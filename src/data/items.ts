...
export const LOOT_TABLE: Record<string, LootDef> = {
  ...
  coracao_geodo: {
    id: 'coracao_geodo',
    name: 'Coração de geodo',
    baseValue: 100,
    rarity: 'rare',
  },
  prisma_refrator: {
    id: 'prisma_refrator',
    name: 'Prisma refrator',
    baseValue: 120,
    rarity: 'rare',
  },
  ...
  barra_ferro: { id: 'barra_ferro', name: 'Barra de ferro', baseValue: 50, rarity: 'uncommon' },
  cristal_luminescente: {
    id: 'cristal_luminescente',
    name: 'Cristal luminescente',
    baseValue: 110,
    rarity: 'rare',
  },
  estatueta_fungica: {
    id: 'estatueta_fungica',
    name: 'Estatueta fúngica',
    baseValue: 125,
    rarity: 'rare',
  },
  ornamento_prismatico: {
    id: 'ornamento_prismatico',
    name: 'Ornamento prismático',
    baseValue: 165,
    rarity: 'rare',
  },
  incensario_termal: {
    id: 'incensario_termal',
...
export function getEnemyChestDrop(speciesId: string, _isBoss: boolean): EnemyChestDrop {
  ...
  switch (speciesId) {
    ...
    case 'cogumante':
      return { lootId: 'madeira_petrificada', quantity: 2, epic: false, goldBonus: 0 };
    case 'ferrao_fungico':
      return { lootId: 'chifre_fungico', quantity: 1, epic: false, goldBonus: 12 };
    case 'prismarin':
    ...
    case 'gema_viva':
      return { lootId: 'coracao_geodo', quantity: 1, epic: false, goldBonus: 10 };
    case 'refrator':
      return { lootId: 'prisma_refrator', quantity: 1, epic: false, goldBonus: 15 };
    case 'salamandra':
    ...
    case 'lodo_vivo':
      return { lootId: 'lodo_termal', quantity: 2, epic: false, goldBonus: 0 };
    case 'fenix_bruma':
      return { lootId: 'pluma_bruma', quantity: 1, epic: false, goldBonus: 18 };
    default:
