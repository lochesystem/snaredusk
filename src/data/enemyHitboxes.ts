...
const ENEMY_HITBOXES: Record<string, EnemyHitboxProfile> = {
  ...
  cogumante: { hitRadius: 25, hitOffsetY: -29, collisionRadius: 16, statusBarY: -57 },
  ferrao_fungico: { hitRadius: 31, hitOffsetY: -20, collisionRadius: 20, statusBarY: -44 },
  ...
  gema_viva: { hitRadius: 31, hitOffsetY: -25, collisionRadius: 23, statusBarY: -53 },
  refrator: { hitRadius: 31, hitOffsetY: -20, collisionRadius: 16, statusBarY: -43 },
  ...
  lodo_vivo: { hitRadius: 31, hitOffsetY: -21, collisionRadius: 23, statusBarY: -46 },
  fenix_bruma: { hitRadius: 30, hitOffsetY: -27, collisionRadius: 16, statusBarY: -54 },
